...
from light_curve import import_swift, flux2luminosity, wavelength2freq
from utils import *
...
def main():
    ...
    for sn_name in det_sne:
        ...
        ax.errorbar(detections[x_col], detections[y_col], 
    ...
    for i, sn_name in enumerate(detections.index):
        ...
        ax.scatter(obs.rest_phase, obs.luminosity_hz, marker=markers[i], s=64, 
...
def plot_nondetection_limits(ax, sn, band, x_col, yerr_col, ymax=1e28):
    ...
    ax.scatter(below_cut[x_col], PLOT_SIGMA * below_cut[yerr_col], 
    ...
    ax.scatter(above_cut[x_col], PLOT_SIGMA * above_cut[yerr_col], 
